                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', backgroundColor: "#fff" }}>
                    ...
                    <View style={{ paddingLeft: moderateScale(15), paddingRight: moderateScale(15) }} >
                        <View style={{ marginBottom: windowHeight * 0.04 }}>
                            ...
                            <Text style={{ color: '#847F7F', fontSize: 8, fontFamily: 'Poppins_400Regular', marginBottom: 0 }}>A verification code is shared on your given number 98*******8</Text>
                        </View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <FormControl>
                                <FormControl.Label><Text style={{ color: "#074B66", fontSize: 12, fontFamily: 'Poppins_500Medium', marginBottom: 0 }}>Get OTP on Phone</Text> </FormControl.Label>
                                <CodeField
