...
export default function AddUser({ navigation, route }) {
    ...
    const todoRef = firebase.firestore().collection('AdminData');
    const addField = () => {
            ...
            <ScrollView style={{ backgroundColor: "#fff" }}>
                ...
                <View style={{ padding: 15 }} >
                    <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
                        <Button borderRadius={100} backgroundColor="#81CEEC" style={{ color: "#074B66", width: "100%" }} onPress={addField}><Text color={'#074B66'} style={{ fontSize: 14, fontFamily: 'Poppins_500Medium', marginBottom: 0 }}>Submit</Text></Button>
                    </View>
