...
export default function RejectDetail({ navigation }) {
    //FONTS
        ...
        <NativeBaseProvider>
            ...
            <ScrollView style={{ backgroundColor: "#fff" }}>
                <View style={{ padding: moderateScale(15) }}>
                    ...
                    <View style={{ height: 'auto', marginTop: 30, borderLeftWidth: 4, borderColor: "#FF4545", backgroundColor: '#fff', borderRadius: 5, paddingTop: 10, paddingBottom: 10, elevation: 3 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', }}>
                            <Text style={{ fontSize: scale(14), fontFamily: 'Poppins_500Medium', backgroundColor: "#FF4545", color: '#fff', width: scale(140), padding: 3, textAlign: "center", borderBottomRightRadius: 12, borderTopRightRadius: 12, }}>Reject</Text>
